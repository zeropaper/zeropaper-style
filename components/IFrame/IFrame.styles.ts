  ...
  ({
    ...
    return {
      ...
      iframe: {
        ...
        backgroundImage:
          "linear-gradient(#eee 2px, transparent 2px), linear-gradient(90deg, #eee 2px, transparent 2px), linear-gradient(#eee 1px, transparent 1px), linear-gradient(90deg, #eee 1px, #fff 1px)",
      ...
      toggleButton: {
        ...
        ...transitionBase,
        fontSize: "1.25em",
        boxShadow: `0 0 7px 0px ${fn.rgba(
          colorScheme === "dark" ? colors.gray[1] : colors.dark[7],
          0.15
        )}`,
        "&:hover": {
          boxShadow: `0 0 7px 3px ${fn.rgba(
            colorScheme === "dark" ? colors.gray[1] : colors.dark[7],
            0.15
          )}`,
        },
